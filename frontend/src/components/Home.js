      ...
      <div className="page home">
        <header>
          <div className="hero-unit">
            ...
            <h1>React MobX React-Router 4 Beego Boilerplate</h1>
          </div>
          <div className="hero-subunit">
            <h4>
              A simple starting point for React with routing, data-fetching, state management and backend with authentication!
            </h4>
          </div>
          <div className="github-buttons">
            <a
              href="https://github.com/tozzr/react-mobx-react-router4-beego-boilerplate"
              target="_blank"
            >
        ...
        <main>
          ...
          <div className="boilerplate-item">
            <div className="boilerplate-logo beego" />
            <div className="boilerplate-item-content">
              <a href="http://beego.me/" target="_blank">
                <h4>beego</h4>
              </a>
              <small>popular web framework in go</small>
              <p>
                Beego makes creating we apps with go very fast and convenient.
              </p>
            </div>
          </div>
